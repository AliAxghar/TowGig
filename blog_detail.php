...
<head>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v8.0" nonce="Ep2IYCjj"></script>
...
<body class="aboutbody" id="aboutus">
    ...
    <div id="aboutcontainer3" class="promopage1" style="padding-bottom: 0px;">
        <div class="container htw">
            <!-- <h2 class="privacyh2">Blog Page</h2> -->
            <div class="row">
                <div class="col-md-8">
                    <div class="text-center">
                        ...
                        ?>
                        <div class="fb-share-button btn btn-lg btn-social" data-href="<?php echo $actual_link;?>" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Frealpython.com%2Fget-started-with-django-1%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
                        <a class="twitter-share-button btn btn-sm btn-social btn-tw mr-3" href="https://twitter.com/intent/tweet?url=<?php echo $actual_link;?>" data-size="large"><i class="fab fa-twitter"></i> Tweet</a> 
                        <a class="linkedin-share-button btn btn-sm btn-social btn-in" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $actual_link;?>"><i class="fab fa-linkedin-in"></i> Share</a> 
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        foreach ($link->query($sql) as $row) {
                            echo '<div class="col-lg-8 entries">';
                            echo '<article class="entry entry-single">';
                            echo '<h2 class="entry-title text-md-left pt-3" style="color: #3d7fc1!important; font-size: 2rem!important;">'
                            .$row['title'].'</h2>';
                                        echo '<div class="entry-content pt-3">';
                                        echo '<p>'.$row['short_description'].'</p>';
                                        echo '</div>';
                                        echo '<div class="entry-img pt-3">';
                                        echo "<img class='post-img' src='images/".$row['image']."' >";
                                        echo '</div>';
                                        echo '<div class="entry-content pt-3">'.$row['description'].'</div>';
                                        echo '</article>';
                                        echo '</div>';
                        }
                        ?>
                        <div class="col-lg-4">
                            <h2 class="text-md-left pb-2" style="font-size: 29px;font-weight: 500;">
                                Latest Articles
                            </h2>
                            <?php
                                        ...
                                        while($row = mysqli_fetch_array($result)){?>
                                            ...
                                            echo '<article class="entry entry-single entry1">';
                                                echo '<div class="row">';
                                                    ...
                                                    ?>
                                                    <p class="text-md-left latest" style="color: #636161!important;font-size: medium;"><?php echo substr($row['short_description'],0,80);?></p>
                                                    <?php
                                                    echo '</div>';
                                                echo '</div>';
                                                echo '<span>';
                                ...
                                echo '<br>';
                            echo '<div class="pt-5">';
                                echo '<h2 class="text-md-left pb-2" style="font-size: 29px;font-weight: 500;">
                                    Paragraph
                                </h2>';
                                    $sql = "SELECT * FROM post WHERE Id=".$_GET['Id'];
                                    foreach ($link->query($sql) as $row) {
