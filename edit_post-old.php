...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($image_temp != "")
    {
        ...
        $update="update post set title='$title' ,category='$category' ,short_description='$short_description' ,description='$description' ,image='$image'
        WHERE Id='$Id'";
        mysqli_query($link, $update);
        header("location:allblogs.php");
    }else
    {
        $update="update post set title='$title' ,category='$category' ,short_description='$short_description' ,description='$description'
        WHERE Id='$Id'";
        mysqli_query($link, $update);
        header("location:allblogs.php");
    }
