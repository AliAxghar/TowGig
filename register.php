        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mr-2" href="addpost.php">Add Blog</a>
                    </li>
                    <!-- <li class="nav-item">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="wrapper pb-5">
                <p class="text-center pt-4">Please fill this form to create an account.</p>
                <form class="pt-3" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                        ...
                        <input type="password" name="password" class="form-control" value="<?php echo $password; ?>" require>
                        <span class="help-block"><?php echo $password_err; ?></span>
                    </div>
                    <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                        <label>Confirm Password</label>
                        <input type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>" require>
